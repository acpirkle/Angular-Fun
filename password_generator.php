...
<body>
  <a href="contact_book.php" class="btn">Contact Book</a>
        ...
        <div class="col-lg-2"></div>
          <div class="input-group col-12 col-lg-8" id="pswrd_suggested_div">
            ...
            <div class="input-group-append">
              <button type="button" class="btn" ngclipboard data-clipboard-target="#password_suggested" data-toggle="tooltip" data-trigger="click" title="Copied!"><i class="fas fa-clipboard"></i></button>
            </div>
          </div>
      </div>
    </div>
